...
def ensure_models_downloaded():
    ...
    if not os.path.exists(sentinel):
        ...
        try:
            ...
            # Try as a Model repo first (default), fallback to Dataset
            try:
                snapshot_download(
                    repo_id="zangerin/DeepBov_epics",
            ...
            st.success("✅ Models downloaded successfully from Hugging Face! Reloading...")
            st.rerun()
        except Exception as e:
            st.error("🚨 Hugging Face download failed. Please ensure the repository is public and contains the 'models' folder.")
