...
def predict(side_fname,rear_fname):
    ...
    try:
        ...
        try:
            ...
            print("DEBUG: Det model loaded")
            print(type(side_det_model))
        except Exception as e:
            print(f'DEBUG: Det model load failed: {e}')
    ...
    # KPT rear and side
        ...
        if(cattle/sticker<50):
            ...
            res = {"weight":predicted_cattle_weight,"ratio": cattle/sticker ,"remarks":status,"shoulder":side_Length_shoulderbone,"F_Girth":side_F_Girth,	"R_Girth":side_R_Girth, "sticker":sticker, "cattle":cattle , "actual_width": actual_width}
        ...
        print(f"DEBUG: Main try block failed with error: {e}")
        import traceback
        traceback.print_exc()
